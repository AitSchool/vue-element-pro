    ...
    <div class="account-login-bd">
      ...
      <div class="account-login-mainer">
        <div class="login-tab-container">
          <div :class="['login-tab-item', { active: passwordMode }]"
            @click="passwordMode = !passwordMode">账号密码登录</div>
          <div :class="['login-tab-item', { active: !passwordMode }]"
            @click="passwordMode = !passwordMode">手机登录</div>
        </div>
            ...
            <el-form
              ...
              <el-form-item  prop="checked">
                <div class="flex-cell">
                  <el-checkbox
                    class="flex-cell-bd"
                    v-model="passwordFrom.checked">自动登录</el-checkbox>
                  <el-link class="flex-cell-ft" type="primary">忘记密码</el-link>
                </div>
              </el-form-item>
              <el-form-item>
                <el-button
              ...
              <el-form-item >
                <div class="flex-cell">
                  ...
                  <router-link
                    ...
                    type="primary"
                    :to="{name: 'AccountRegister'}">注册账号</router-link>
                </div>
              </el-form-item>
            </el-form>
          </div>
            ...
            <el-form :model="smsFrom" status-icon :rules="smsRules" ref="smsFrom">
              ...
              <el-form-item  prop="checked">
                <div class="flex-cell">
                  <el-checkbox
                    class="flex-cell-bd"
                    v-model="smsFrom.checked">自动登录</el-checkbox>
                  <el-link class="flex-cell-ft" type="primary">忘记密码</el-link>
                </div>
              </el-form-item>
              <el-form-item>
                <el-button
                  type="primary"
                  style="width: 100%"
                  @click="submitForm('smsFrom')">登录</el-button>
              </el-form-item>
              <el-form-item >
                <div class="flex-cell">
                  <span class="flex-cell-bd"></span>
